...
def main():
    ...
    # Construct Tree
    d_tree = tree.DecisionTreeClassifier(max_depth=6)
    d_tree.fit(x_train, y)
    acc = d_tree.score(x_train, y)
    print('Training acc:', acc)
    tree.export_graphviz(d_tree, feature_names=feature_names, out_file='my_d_tree_fig')
